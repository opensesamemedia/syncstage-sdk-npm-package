...
export enum RequestResponseMap {
  ...
  SetLatencyOptimizationLevelRequest = SyncStageMessageType.SetLatencyOptimizationLevelRequest,
  SetLatencyOptimizationLevelResponse = SyncStageMessageType.SetLatencyOptimizationLevelResponse,
